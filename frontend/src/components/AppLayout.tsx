...
const nav = [
  { to: "/", label: "API logs", icon: <ListAltOutlinedIcon /> },
  { to: "/overview", label: "Overview", icon: <AssessmentOutlinedIcon /> },
          ...
          >
            <Box
              sx={{
                ...
                boxShadow: (t) =>
                  `0 0 0 3px ${alpha(health.isLoading ? t.palette.grey[400] : online ? t.palette.success.main : t.palette.error.main, 0.25)}`,
              }}
            />
            <Typography
              variant="caption"
